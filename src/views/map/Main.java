...
import views.map.World.Resolution;
...
import views.map.resources.FontIcon;
import views.map.resources.MaterialDesign;
...
import static views.map.Country.*;
import static views.map.Country.GB;
import static views.map.Country.PL;
