...
//		String[] listOfCodes = {"MLT", "RO", "LIE"};
		...
		OneCountryOneIndicatorLineChart lc = new OneCountryOneIndicatorLineChart (Networking.getInstance().getRangeOfIndicatorsForCountries(listOfCodes, inflation, "1980", "2015"));
